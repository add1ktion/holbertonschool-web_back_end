...
- **[1. More mapping](./1-get_list_student_ids.js)**
  ...
  - This function accepts one argument which is an array of objects in the same format as `getListStudents`.
...
- **[8. Clean set](./8-clean_set.js)**
  ...
  - When a value starts with `startString` you only append the rest of the string. The result string contains all matching values of the set separated by `-`.
...
- **[10. More map data structure](./10-update_uniq_items.js)**
  ...
  - It should accept a map as an argument. The map it accepts is similar to the map created in the previous task.
